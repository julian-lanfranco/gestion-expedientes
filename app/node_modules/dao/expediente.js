...
var coleccionSelecc1 = "expedientes";
	...
	actualizar: function(docEntidad,callback){
		dbConn.conectar(function(db){
			...
			update({"_id" : new ObjectId(id)},
				{"nroExpediente":docEntidad.nroExpediente,
				"caratula":docEntidad.caratula,
				"fecha":docEntidad.fecha,
				"tema":docEntidad.tema,
				"iniciador":docEntidad.iniciador,
				},
